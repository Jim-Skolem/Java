...
public class Test1 {
	...
	static void seg() throws IOException{	
		...
		OutputStreamWriter writer1 = new OutputStreamWriter(new FileOutputStream(new File("T1.txt")),"gbk");
		OutputStreamWriter writer2 = new OutputStreamWriter(new FileOutputStream(new File("T2.txt")),"gbk");
		//声明所需的变量
		String str = null;
		String key = null;			
